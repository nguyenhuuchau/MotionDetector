...
void MixtureOfGaussianV2BGS::reset()
{
}
void MixtureOfGaussianV2BGS::setThreshold(int threshold)
{
	this->threshold=threshold;
	saveConfig();
}
void MixtureOfGaussianV2BGS::setEnableThreshold(bool enable)
{
...
bool MixtureOfGaussianV2BGS::isEnableThreshold()
{
	return enableThreshold;
}
int MixtureOfGaussianV2BGS::getThreshold()
{
	return threshold;
}
