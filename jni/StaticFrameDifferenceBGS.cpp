...
void StaticFrameDifferenceBGS::process(const cv::Mat &img_input, cv::Mat &img_output, cv::Mat &img_bgmodel)
{
  ...
  if(resetBackground||img_background.empty())
  {
...
void StaticFrameDifferenceBGS::setThreshold(int threshold)
{
	this->threshold=threshold;
	saveConfig();
}
void StaticFrameDifferenceBGS::setEnableThreshold(bool enable)
{
...
bool StaticFrameDifferenceBGS::isEnableThreshold()
{
	return enableThreshold;
}
int StaticFrameDifferenceBGS::getThreshold()
{
	return threshold;
}
