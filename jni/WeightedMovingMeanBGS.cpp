...
void WeightedMovingMeanBGS::reset()
{
}
void WeightedMovingMeanBGS::setThreshold(int threshold)
{
	this->threshold=threshold;
	saveConfig();
}
void WeightedMovingMeanBGS::setEnableThreshold(bool enable)
{
...
bool WeightedMovingMeanBGS::isEnableThreshold()
{
	return enableThreshold;
}
int WeightedMovingMeanBGS::getThreshold()
{
	return threshold;
}
