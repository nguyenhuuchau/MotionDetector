...
void WeightedMovingVarianceBGS::reset()
{
}
void WeightedMovingVarianceBGS::setThreshold(int threshold)
{
	this->threshold=threshold;
	saveConfig();
}
void WeightedMovingVarianceBGS::setEnableThreshold(bool enable)
{
...
bool WeightedMovingVarianceBGS::isEnableThreshold()
{
	return enableThreshold;
}
int WeightedMovingVarianceBGS::getThreshold()
{
	return threshold;
}
